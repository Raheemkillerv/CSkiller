...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mMR HackerBoss█████████████████▒▒▒▒▒▒▒▒..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(0.1)
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:MR-Hacker-boss
	    time.sleep(2)
            loop = 'false'
        else:
...
def login1():
	...
	try:
		...
		os.system('clear')
                time.sleep(0.05)
		print logo                
		print "\033[1;98m•-----------------\033[1;98mBoss\033[1;98m-----------------•"
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\033[1;47m\033[1;94mHackerBossogin Successful\033[1;0m'
				os.system('xdg-open https://www.youtube.com/channel/UCd-xhGAkBU4_0l0CIqwxTjw')
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:MR-HackerBoss
	print logo
	...
	time.sleep(0.05)
	print "\033[1;98m•-----------------\033[1;94mMR Hacker Boss\033[1;98m-----------------•"
	print "\033[1;92m[1]\033[1;34mStart Fast Cloning"
	time.sleep(0.05)
	print "\033[1;93m[2]\033[1;34mID Not Found Problem Solve"
	time.sleep(0.05)
	print "\033[1;94m[3]\033[1;34mRest/Update Hacker Boss TOOL"
	time.sleep(0.05)
...
def pilih():
	...
	if unikers =="":
		...
		print "\033[1;95m...............\033[1;91mDataReset\033[1;95m.................."
                ...
                jalan('\033[1;95m=========90%')
                jalan('\033[1;94m==========100%')
                jalan('\033[1;93mCloning Data Reset and update by Hacker Boss')
...
def pilih_super():
	...
	if peak =="":
		...
		print logo
		jalan('\033[1;91m[+]\033[1;98mMR Hacker Boss█████████████████▒▒▒▒▒▒▒▒..99%')
		...
		os.system('clear')
		print "\033[1;98m•-----------------\033[1;35mHackerBoss\033[1;98m-----------------•"
		print logo
	...
	p.map(main, id)
#Dev:MR-SH4DOW-ALONE
        print "\033[1;98m•-----------------\033[1;38mHackerBoss\033[1;98m-----------------•"
...
"""
	print "\033[1;95m«-----------------\033[1;35m✅HackerBoss✅\033[1;95m-----------------»"
